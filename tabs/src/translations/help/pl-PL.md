...
Aby udostępnić frazę, odblokuj ekran tylko po raz pierwszy, przejdź do ustawień > Nawigacja i przyciski > i włącz opcję 'Pokaż przycisk udostępniania frazy'.
...
### <a name='HowdoIchangehowavoicesounds'></a>Jak zmienić jak dźwięk głosowy?
...
Następnie powinieneś zobaczyć kilka dużych przycisków na górze i na dole płytki, jeśli jest wystarczająco duża, jak pokazano na poniższym obrazie:
